  ...
  return (
    <>
      <div className="max-w-full h-[35rem] bg-accent-100 relative flex justify-center items-center">
        ...
        <div className="h-full w-full bg-black/60 bg-opacity-30 absolute z-0"></div>
        <div className="flex flex-col justify-center items-center h-full w-full gap-6 mb-28 z-10">
          <div className="flex flex-col justify-center items-center gap-2">
            <h2 className="text-3xl font-semibold font-sans text-bg-100">
          ...
          <div className="text-base font-sans text-bg-100">
            Finding{" "}
